        ...
        \begin{center}
            \begin{minipage}[t]{\textwidth}
                \begin{center}
                    ...
                    \caption[Querschnitt einer CD \newline verändert nach \url{http://daten.didaktikchemie.uni-bayreuth.de/umat/cd_dvd/cd-ausschnitt.gif} (zuletzt aufgerufen am 07.08.2015)]{Querschnitt einer CD}
                    \label{fig:cdquer}
                \end{center}
            \end{minipage}
        \end{center}
...
%da es aufgrund der destruktiven Interferenz\footnote{Wellenberg und %Wellental
%zweier Lichtstrahlen mit gleicher Frequenz und Amplitude treffen aufeinander
%und heben sich gegenseitig auf.} zu einer teilweisen Auslöschung desLaserlichts
%kommt.
