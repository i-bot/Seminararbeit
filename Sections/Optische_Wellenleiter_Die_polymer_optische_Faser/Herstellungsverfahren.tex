\subsection{Herstellung von polymer optischen Fasern}
        ...
        \begin{center}
            \begin{minipage}[t]{\textwidth}
                \begin{center}
                    ...
                    \caption[kontinuierliche Extrusion einer SI-POF \newline \url{http://www.researchgate.net/publication/265646639_An_overview_on_fabrication_methods_for_polymer_optical_fibers} S. 5 (zuletzt aufgerufen am 28.09.2015)]{kontinuierliche Extrusion einer SI-POF}
...
Die kontinuierliche Extrusion eignet sich ebenfalls für die Herstellung von
polymer optischen Fasern mit \textit{Multi Step Index}. Dabei kommen mehrere
Extruder zum Einsatz (siehe \autoref{fig:pofmsispinn}), die nacheinander
Mantelschichten auf den Kern auftragen, sodass mehrere übereinanderliegende
Mäntel entstehen. \cite{pofspinn}
        ...
        \begin{center}
            \begin{minipage}[t]{\textwidth}
                \begin{center}
                    ...
                    \caption[kontinuierliche Extrusion einer polymer optischen Faser mit \textit{Multi Step Index} \newline \url{http://www.researchgate.net/publication/265646639_An_overview_on_fabrication_methods_for_polymer_optical_fibers} S. 5 (zuletzt aufgerufen am 28.09.2015)]{kontinuierliche Extrusion einer polymer optischen Faser mit \textit{Multi Step Index}}
...
\subsubsection{Herstellung einer GI-POF mittels modifiziertem Schmelzspinnprozess}
