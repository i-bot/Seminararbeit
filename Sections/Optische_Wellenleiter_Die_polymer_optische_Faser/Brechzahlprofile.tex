    ...
    \begin{center}
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \newline
                \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/images/profil_dsi-pof.png}]{\shorthandoff{"}"\shorthandon{"}\shorthandoff{"}Dual
                Step Index"\shorthandon{"} - POF (zwei Mäntel, Stufenindex)}
                \label{fig:pofdsi}
            \end{center}
        \end{minipage}
        ...
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \newline
                \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/images/profil_msi-pof.png}]{\shorthandoff{"}"\shorthandon{"}\shorthandoff{"}Multi
                Step Index"\shorthandon{"} - POF (mehrere Mäntel, Stufenindex)}
                \label{fig:pofmsi}
            \end{center}
        \end{minipage}
    ...
    \begin{center}
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/images/profil_mc-pof.png}]{\shorthandoff{"}"\shorthandon{"}\shorthandoff{"}Multi
                Core"\shorthandon{"} - POF (mehrere Kerne, Stufenindex)}
                \label{fig:pofmc}
            \end{center}
        \end{minipage}
        ...
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/images/profil_dsi-mc-pof.png}]{\shorthandoff{"}"\shorthandon{"}\shorthandoff{"}Dual
                Step Index - Multi Core"\shorthandon{"} - POF (mehrere Kerne,
                zwei Mäntel, Stufenindex)}
                \label{fig:pofdsimc}
            \end{center}
