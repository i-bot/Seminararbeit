    ...
    \begin{center}
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \caption[Aufbau eines Kabels aus POF \newline \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/phys_prinzip.php}]{Aufbau eines Kabels aus POF} %TODO: Get url
        ...
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \caption[Ausbreitung von Licht in einem optischen Wellenleiter \newline \url{ITWissen}]{Ausbreitung von Licht in einem optischen Wellenleiter} %TODO: Get url, better resolution
    ...
    \begin{center}
        \begin{minipage}[t]{0.4\textwidth}
            \begin{center}
                ...
                \caption[Dämpfungsfenster bei einer polymer optischen Faser \newline \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/stufenindex.php}]{Dämpfungsfenster bei einer polymer optischen Faser} %TODO: Get url
