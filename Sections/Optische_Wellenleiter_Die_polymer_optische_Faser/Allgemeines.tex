        ...
        \begin{center}
            \begin{minipage}[t]{\textwidth}
                \begin{center}
                    ...
                    \caption[Gründe für die Verwendung von POF-Kabeln \newline \url{http://www.pofac.fh-nuernberg.de/pofac/de/was_sind_pof/images/warum_pof.png} (zuletzt aufgerufen am 19.09.2015)]{Gründe für die Verwendung von POF-Kabeln}
                    \label{fig:pofgrund}
                \end{center}
            \end{minipage}
        \end{center}
